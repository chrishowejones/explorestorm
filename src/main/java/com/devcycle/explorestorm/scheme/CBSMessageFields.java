...
public class CBSMessageFields implements Serializable {
    ...
    public static final String FIELD_MSG_TIMESTAMP_STORM = "MSG_TIMESTAMP_STORM"; // timestamp message created read into Storm
    ...
    private static Map<String, Class> types = new HashMap<String, Class>() {
        {
            ...
            put(FIELD_MSG_TIMESTAMP_STORM, Long.class);
            put(FIELD_MSG_TIMESTAMP_STORMHBASE, Long.class);
        }
    };
